        ...
        >
          ...
          >
            <MemoizedChartRenderer 
              ...
              filterValues={filterValues[chart.id]}
              onFilterChange={(filterType: string, value: string) => handleFilterChange(chart.id, filterType, value)}
              ...
              onColorsGenerated={(colorMap: Record<string, string>) => syncLegendColors(chart.id, colorMap)}
