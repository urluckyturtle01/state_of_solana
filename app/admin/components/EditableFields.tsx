  ...
  return (
    <div className="space-y-6">
          ...
          <div key={api.id} className="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm rounded-md transition-colors"
                  >
            ...
            <div>
              ...
              {api.responseColumns.length === 0 ? (
                <div className="bg-gray-900/30 border border-gray-700 rounded-md p-4 text-center space-y-3">
                  <div className="text-gray-400 text-sm">
                    <p className="mb-2">🔍 No column definitions yet</p>
                    <p className="text-xs">Click <strong>"🚀 Auto-Generate All Column Definitions"</strong> at the top to fetch all APIs at once,</p>
                    <p className="text-xs">or use <strong>"🔍 Test API Response"</strong> to preview this API's data structure.</p>
                  </div>
                  <div className="border-t border-gray-700 pt-3">
                    <p className="text-xs text-gray-500">
                      💡 The AI will automatically analyze response structure and generate intelligent descriptions!
                    </p>
                  </div>
                </div>
              ) : (
      ...
      <div className="bg-gray-900/30 border border-gray-700 rounded-lg p-4">
        <h3 className="text-sm font-medium text-gray-300 mb-2">📋 Quick Guide:</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-gray-400">
          <div>
            <h4 className="font-medium text-gray-300 mb-1">✏️ Editing:</h4>
            <ul className="space-y-1">
              ...
              <li>• Changes are automatically tracked for saving</li>
            </ul>
          </div>
          <div>
            <h4 className="font-medium text-gray-300 mb-1">🚀 AI Features:</h4>
            <ul className="space-y-1">
              <li>• Click "🚀 Auto-Generate All Column Definitions" to fetch all 219 APIs</li>
              <li>• AI automatically generates intelligent column descriptions</li>
              <li>• Column types are detected from actual API responses</li>
              <li>• Add or remove response columns manually if needed</li>
              <li>• Save your changes to S3 using the "Save to S3" button</li>
            </ul>
          </div>
        </div>
        <div className="mt-3 p-2 bg-blue-900/20 border border-blue-800 rounded text-xs text-blue-300">
          💡 <strong>Pro Tip:</strong> The AI analyzes actual API responses to generate accurate column definitions with contextual descriptions based on blockchain, financial, and data patterns.
        </div>
      </div>
    </div>
  );
