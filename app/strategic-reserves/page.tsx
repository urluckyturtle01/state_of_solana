...
// SEO Structured Data
const structuredData = generateStructuredData('/strategic-reserves');

export default function StrategicReservesIndexPage() {
  const router = useRouter();
  
  useEffect(() => {
    router.replace("/strategic-reserves/general-stats");
  }, [router]);
