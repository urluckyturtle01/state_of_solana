...
export default function XStocksTabsHeader({ activeTab = "financials" }: XStocksTabsHeaderProps) {
  const tabs: Tab[] = [
    { 
      name: "Financials", 
      path: "/xstocks/financials",
      key: "financials",
  ...
  return (
    <TabsNavigation 
      ...
      activeTab={activeTab}
      title="Xstocks"
      description="Onchain metrics, activity and charts for the Xstocks on Solana"
      showDivider={true}
    />
  );
} 