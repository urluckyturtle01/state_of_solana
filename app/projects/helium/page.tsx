...
// SEO Structured Data
const structuredData = generateStructuredData('/projects/helium');
...
export default function HeliumPage() {
  ...
  useEffect(() => {
    ...
    router.replace("/projects/helium/financials");
  }, [router]);
...
export const metadata = generateNextMetadata('/projects/helium');