...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {showDropdown && (
        <div className="absolute bottom-full left-0 right-0 mb-2 bg-gray-900 border border-gray-700 rounded-lg shadow-xl p-4 space-y-4">
          {!isLoading && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="text-center p-2 bg-gray-800/50 rounded-lg">
                  <div className="text-lg font-bold text-blue-400">{dashboards.length}</div>
                  <div className="text-xs text-gray-500">Dashboards</div>
                </div>
                
              {/*  <div className="text-center p-2 bg-gray-800/50 rounded-lg">
                  <div className="text-lg font-bold text-green-400">{totalCharts}</div>
                  <div className="text-xs text-gray-500">Charts</div>
                </div>*/ }
                
                <div className="text-center p-2 bg-gray-800/50 rounded-lg">
                  <div className="text-lg font-bold text-purple-400">{totalVisualizations}</div>
            ...
            <div className="flex items-center justify-center py-4">
              <div className="text-center">
                <div className="relative w-6 h-6 mx-auto mb-2">
                  <div className="absolute inset-0 border-t border-r border-blue-400/60 rounded-full animate-spin"></div>
                </div>
