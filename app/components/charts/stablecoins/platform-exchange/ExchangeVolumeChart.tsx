...
import { PlatformExchangeDataPoint, fetchPlatformExchangeData, getExchangeColor, formatDate, formatCurrency } from '../../../../api/stablecoins/platform-exchange/platformExchangeData';
...
// Props for the ExchangeVolumeChart component
...
const ExchangeVolumeChart: React.FC<ExchangeVolumeChartProps> = ({
  ...
  const fetchData = useCallback(async () => {
    ...
    setError(null);
    try {
      const chartData = await fetchPlatformExchangeData();
      ...
      console.error('[ExchangeVolumeChart] Error loading chart data:', err);
  ...
  return (
    <div className="h-full w-full relative">
      ...
      <Modal 
        ...
        subtitle="Monthly volume by exchange platform"
      >
